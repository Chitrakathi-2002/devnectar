...
import DevNectar.StaffBridge.CloudNex.repository.DailyReportRepository;
...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (userRepository.findByUsername("admin").isEmpty()) {
            ...
            admin.setEmail("admin@cloudnex.com");
        ...
        if (userRepository.findByUsername("manager").isEmpty()) {
            ...
            manager.setEmail("manager@cloudnex.com");
        ...
        if (userRepository.findByUsername("intern").isEmpty()) {
            ...
            intern.setEmail("alice@cloudnex.com");
