...
import DevNectar.StaffBridge.devNectar.service.ExcelExportService;
import DevNectar.StaffBridge.devNectar.service.PdfExportService;
...
public class AdminAttendanceController {
    ...
    public ResponseEntity<Resource> exportMatrix(
        ...
        List<DevNectar.StaffBridge.devNectar.dto.MatrixRowDTO> matrix = attendanceService.getAttendanceMatrix(month, year, null);
