...
public class PdfExportService {
    ...
    // --- SHARED COLORS & FONTS ---
    private static final BaseColor devNectar_BRAND = new BaseColor(46, 204, 113); // Brand Green
    ...
    private static final Font BRAND_FONT = FontFactory.getFont(FontFactory.HELVETICA_BOLD, 26, devNectar_BRAND);
    ...
    public ByteArrayInputStream exportAttendance(List<Attendance> attendanceList, String reportTitle) {
        ...
        try {
            ...
            Paragraph footer = new Paragraph("\n\ndevNectar Attendance System - Secure Audit Trail", META_FONT);
